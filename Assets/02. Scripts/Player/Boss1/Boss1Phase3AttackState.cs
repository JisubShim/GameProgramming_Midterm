...
public class Boss1Phase3AttackState : IBossState
{
    ...
    public Boss1Phase3AttackState(Boss1StateController boss1StateController, Boss1 boss1, Boss1PatternSystem patternSystem)
    {
    ...
    public void Enter()
    {
        ...
        if (_playCount % 2 == 0)
        {
            ...
            _patternSystem.PlayThrowBombToPlayer(amount: 3, duration: 4f, arcHeight: 6f, travelTime: 1f);
        }
